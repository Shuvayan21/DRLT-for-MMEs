function [Sens_delta, Spec_delta, Sens_beta, Spec_beta, RRMSE] = results_Sens_Spec_RRMSE_gen_gauss(A_tilde, A, beta, delta, sigma, W)
    ...
    eta=gen_ggd_inv(n, sigma^2, 3/2); % Generate generalised gaussian noise with shape parameter 3/2.
    ...
    for k = 1:run
        eta=gen_ggd_inv(n, sigma^2, 3/2); % Generate new noise for each run.
