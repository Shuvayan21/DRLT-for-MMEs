...
%% Plot for Fig 7(top-left) in supplemental (Sensitivity and Specificity for delta)
% Plotting
figure;
hold on;
...
grid on;
hold off;
%% Plot for Fig 8(top-left) in supplemental (Sensitivity and Specificity for beta)
figure;
hold on;
...
%% Plot for Fig 9(top-left) in supplemental (RRMSE)
figure;
hold on;
