...
RRMSE = zeros(4, size(sparsity, 2));  % Relative Root Mean Square Error
Sens_beta = zeros(4, size(sparsity, 2));  % Sensitivity for beta estimates
Sens_delta = zeros(4, size(sparsity, 2));  % Sensitivity for delta estimates
Spec_beta = zeros(4, size(sparsity, 2));  % Specificity for beta estimates
Spec_delta = zeros(4, size(sparsity, 2));  % Specificity for delta estimates
...
%% Plot for Fig 4(bottom-right) in supplemental (Sensitivity and Specificity for delta)
% Plotting
figure;
hold on;
...
plot(sparsity, Sens_delta(4,:), '-d', 'LineWidth', 6, 'MarkerSize', 20, 'Color', red_4); % diamond
plot(sparsity, Spec_delta(4,:), '--x', 'LineWidth', 6, 'MarkerSize', 20, 'Color', blue_4); % x
% Labels and legend
...
grid on;
hold off;
%% Plot for Fig 5(bottom-right) in supplemental (Sensitivity and Specificity for beta)
figure;
hold on;
...
plot(sparsity, Sens_beta(4,:), '-d', 'LineWidth', 6, 'MarkerSize', 20, 'Color', red_4); % diamond
plot(sparsity, Spec_beta(4,:), '--x', 'LineWidth', 6, 'MarkerSize', 20, 'Color', blue_4); % x
...
%% Plot for Fig 6(bottom-right) in supplemental (RRMSE)
figure;
hold on;
...
plot(sparsity, RRMSE(4,:), '-d', 'LineWidth', 6, 'MarkerSize', 20);
